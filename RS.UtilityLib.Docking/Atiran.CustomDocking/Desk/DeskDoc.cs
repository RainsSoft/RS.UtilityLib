...
namespace Atiran.CustomDocking.Desk {
    public partial class DeskDoc : DockContent {
        public DeskDoc() : base() {
            InitializeComponent();
        ...
        */
        ...
        //{
        //    System.Windows.Forms.MessageBox.Show("This is to demostrate menu item has been successfully merged into the main form. Form Text=" + Text);
        //}
