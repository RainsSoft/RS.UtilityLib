...
namespace Xceed.Wpf.AvalonDock.Controls
{
    internal class DragService
    {
        ...
        private void GetOverlayWindowHosts() {
            ...
            var ot = _manager.GetFloatingWindowsByZOrder().OfType<LayoutAnchorableFloatingWindowControl>();
            var arr = ot.Where(fw => fw != _floatingWindow && fw.IsVisible);
            _overlayWindowHosts.AddRange(arr.ToArray());
