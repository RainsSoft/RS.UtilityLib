...
namespace RS.UtilityLib.WinFormCommon.UI.ColorPicker
{
    ...
    class CustomColors
    {
        ...
        internal static Color Transparent = Color.Transparent;//Color.FromArgb(192, 192, 192);     
        // ----------------- Fifth Row ------------------------------
        ...
        internal static Color[] SelectableColors =
            {
                ...
                CustomColors.Turquoise, CustomColors.SkyBlue, CustomColors.Plum, CustomColors.Transparent,
        ...
        /// </summary>
        internal static string[] SelectableColorsNamesEN =
            {
                ...
                "Turquoise", "Sky Blue", "Plum", "Transparent",
