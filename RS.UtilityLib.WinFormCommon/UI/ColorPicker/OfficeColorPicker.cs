    ...
    public partial class OfficeColorPicker : UserControl
    {
       ...
       DefaultValue(typeof(Color), "System.Drawing.Color.Black")]
        ...
        protected void PaintMoreColorsButton(Graphics graphics, int x, int y) {
            ...
            //  Draw the string itself using the rectangle, font and m_TexFormat specified.
            graphics.DrawString("更多颜色...", buttonFont, Brushes.Black, buttonRec, format);
            format.Dispose();
            buttonFont.Dispose();
