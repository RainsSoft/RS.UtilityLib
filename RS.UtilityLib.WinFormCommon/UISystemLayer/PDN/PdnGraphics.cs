    ...
    public static class PdnGraphics
    {
        ...
        internal unsafe static void GetRegionScans(IntPtr hRgn, out Rectangle[] scans, out int area)
        {
            ...
            else
            {
                ...
                data = (byte*)Memory_Allocate(bytes).ToPointer();
            }                        
        ...
        public static IntPtr Memory_Allocate(ulong bytes) {
        ...
        public static void Memory_Free(IntPtr block) {
