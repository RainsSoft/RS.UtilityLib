...
namespace RS.UtilityLib.WinFormCommon.UISystemLayer
{
        ...
        : Control
    {
        ...
        private Image pdnLogo = Properties.Resources.TransparentLogo;//PdnResources.GetImage("Images.TransparentLogo.png");
        ...
        private Image[] banners = new Image[]
            {
                Properties.Resources.Banner//PdnResources.GetImage("Images.Banner.png"),
            };
