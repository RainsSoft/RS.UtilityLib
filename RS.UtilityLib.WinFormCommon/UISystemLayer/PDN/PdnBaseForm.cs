...
namespace RS.UtilityLib.WinFormCommon.UISystemLayer
{
          ...
          
    {
        ...
        private bool IsTargetFormActive(object target)
        {
            ...
            if (targetControl == null)
            {
                IHotKeyTarget asIFormAssociate = target as IHotKeyTarget;
        ...
        public PdnBaseForm()
        {
            ...
            this.formEx = new FormEx(this, new ParentWndMsgProcDelegate(this.RealWndProc));
        ...
        private void SetFormOpacity(PdnBaseForm pdnBaseForm, double value) {
            pdnBaseForm.Opacity = value;
        }
        ...
        {
            if (!PdnBaseForm.globalEnableOpacity || !this.EnableInstanceOpacity)
            {
