...
{
    public delegate void ParentWndMsgProcDelegate(ref Message m);
    /// <summary>
    ...
    {
        private Form host;
        private ParentWndMsgProcDelegate realParentWndProc;
        ...
        public FormEx(Form host, ParentWndMsgProcDelegate realParentWndProc) {
            this.host = host;
