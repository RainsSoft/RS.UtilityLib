...
namespace RS.UtilityLib.WinFormCommon.UISystemLayer
{
        ...
        : Control
    {
        ...
        public ControlShadow()
        {
            ...
            this.roundedEdgeUL = Properties.Resources.RoundedEdgeUL;// ImageResource.Get("Images.RoundedEdgeUL.png").Reference;
            this.roundedEdgeUR = Properties.Resources.RoundedEdgeUR;// ImageResource.Get("Images.RoundedEdgeUR.png").Reference;
            this.roundedEdgeLL = Properties.Resources.RoundedEdgeLL;// ImageResource.Get("Images.RoundedEdgeLL.png").Reference;
            this.roundedEdgeLR = Properties.Resources.RoundedEdgeLR; //ImageResource.Get("Images.RoundedEdgeLR.png").Reference;

            if (!PdnInfo.IsFinalBuild && !betaTagDone)
            {
                betaTagDone = true;

                string betaTagStringFormat ="{0},{1}";// PdnResources.GetString("ControlShadow.BetaTag.Text.Format");
                string appName = Application.StartupPath;//PdnInfo.GetFullAppName();
