...
namespace ShareX
{
    ...
    {
        public SurfaceOptions SurfaceOptions { get; internal set; }
        public TaskSettingsCapture CaptureSettings = new TaskSettingsCapture();
        internal static TaskSettings GetDefaultTaskSettings()
        {
            TaskSettings ts = new TaskSettings();
            ts.SurfaceOptions = ts.CaptureSettings.SurfaceOptions;
            ts.SurfaceOptions.IsFixedSize = false;
            ts.SurfaceOptions.FixedSize=new System.Drawing.Size(250,250);
            ts.SurfaceOptions.MagnifierPixelCount = 5;        
            ts.SurfaceOptions.ShowInfo = true;
            ts.SurfaceOptions.QuickCrop = false;
            ts.SurfaceOptions.ShowMagnifier = true;
            ts.SurfaceOptions.ShowCrosshair = false;                 
            //
            ts.CaptureSettings.ShowCursor = true;
            ts.CaptureSettings.CaptureShadow = true;
            ts.CaptureSettings.CaptureShadowOffset = 40;
            ts.CaptureSettings.CaptureClientArea = false;
            ts.CaptureSettings.CaptureAutoHideTaskbar = false;
            return ts;
        }
    }
