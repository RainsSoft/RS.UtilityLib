    ...
    public static class EnumExtension
    {
        ...
        public static string Value(this Enum enumerator)
        {
            try
            {
                ...
                var cas = field.GetCustomAttributes(typeof(DescriptionAttribute), false);
                if (cas == null || cas.Length < 1) return enumerator.ToString();
                DescriptionAttribute attribute = cas[0] as DescriptionAttribute;
