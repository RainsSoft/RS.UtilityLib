...
namespace FileExplorer
{
    public static class FileSystem
    {
        ...
        public static void LoadFileTreeAsync(object _node)
        {
            ...
            IEnumerable<string> efse = null;
            try {
                efse = Directory.EnumerateFileSystemEntries(node.ItemData);
            }
            catch (Exception ee) {
                return;
            }
            ...
            foreach (string entry in efse)//Directory.EnumerateFileSystemEntries(node.ItemData))
            {
