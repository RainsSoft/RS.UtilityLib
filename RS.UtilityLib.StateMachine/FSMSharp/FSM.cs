...
{
    /// <summary>
    /// [线程安全FSM] A Finite State Machine. Thread Safely. 
    ...
    public class FSM<T>
    {
        ...
        /// <summary>
        /// Saves a snapshot of the FSM,对值类型(byte/short/int/long...)状态有效
        /// <see cref="FsmSnapshot{T}"/> T must type like: enum/byte/int/short/long... 
        /// </summary>
        ...
        /// <summary>
        /// Restores a snapshot of the FSM taken with SaveSnapshot,对值类型(byte/short/int/long...)状态有效
        /// <see cref="FsmSnapshot{T}"/> must type like: enum/byte/int/short/long... 
        /// </summary>
        ...
        ///  <param name="executeEventInUpdate">是否在update中执行触发事件</param>
        ...
        public void TriggerEvent(string name, EventArgs eventArgs, bool executeEventInUpdate = false) {
            this.m_CurrentStateBehaviour?.TriggerEvent(name, eventArgs, executeEventInUpdate);
        }
        #endregion
    }
